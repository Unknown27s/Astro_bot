...
This index points to the current AstroBot documentation first and keeps older phase-specific notes grouped separately.
...
| Document | Purpose | Time |
|----------|---------|------|
| [COPILOT_GUIDE.md](COPILOT_GUIDE.md) | Workspace-specific agent guidance | 15 min |
| [contribution/CONTRIBUTING.md](contribution/CONTRIBUTING.md) | How to add or change features | 20 min |
| [contribution/WORKFLOW.md](contribution/WORKFLOW.md) | Quick feature checklist | 10 min |
| [development/DEVELOPMENT_GUIDE.md](development/DEVELOPMENT_GUIDE.md) | Feature development patterns | 20 min |
...
|----------|---------|-------|
| [01-QUICKSTART.md](01-QUICKSTART.md) | Older quick-start guide | Contains early-phase setup notes |
| [02-IMPLEMENTATION_SUMMARY.md](02-IMPLEMENTATION_SUMMARY.md) | Earlier implementation log | Useful for history |
| [04-API_ENDPOINTS.md](04-API_ENDPOINTS.md) | API reference from an earlier phase | May not reflect the current API surface |
| [05-ADMIN_RATE_LIMITING.md](05-ADMIN_RATE_LIMITING.md) | Historical admin rate-limiting guide | Kept for reference |
...
2. [guides/QUICKREF.md](guides/QUICKREF.md)
3. [architecture/COMPLETE_UNDERSTANDING.md](architecture/COMPLETE_UNDERSTANDING.md)
4. [development/CODE_CONVENTIONS.md](development/CODE_CONVENTIONS.md)

### Feature work
1. [COPILOT_GUIDE.md](COPILOT_GUIDE.md)
...
- [Known gaps](IMPROVEMENTS_NEEDED.md)
